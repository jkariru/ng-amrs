...
(function(){
    ...
    angular
            ...
            .run(function($rootScope,$state,$location,OpenmrsRestService,OpenmrsSettings,
                ...
                var wsport=61614 // port for above
                ...
                var options={
                    timeout:3,userName:"admin",password:"admin",
                    onSuccess:function(){
                        console.log("mqtt connected");
                        // Connection succeeded; subscribe to our topic, you can add multile lines of these
                        client.subscribe('/mukiii',{qos:1});
                        ...
                        var y=0;
                        while(y<1000){
                            var message=new Paho.MQTT.Message("looping"+y);
                            message.destinationName="/mukiii";
                            client.send(message);
                            y++;
                        }
